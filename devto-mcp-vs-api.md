---
title: MCP vs API Is the Wrong Question
published: false
description: One Azure Functions app exposing the same backend twice, as a REST API and as a remote MCP server, settles the MCP vs API debate the practical way.
tags: azure, dotnet, ai, serverless
canonical_url: https://sjwiggers.com/mcp-vs-api-is-the-wrong-question
# cover_image: https://raw.githubusercontent.com/steefjan1/mcp-vs-api-azure-functions/main/images/mcp-vs-api-diagram.png
---
...
![MCP vs API: two doors into the same backend](https://raw.githubusercontent.com/steefjan1/mcp-vs-api-azure-functions/main/images/mcp-vs-api-diagram.png)
...
![Deployment architecture: one Flex Consumption function app serving both doors](https://raw.githubusercontent.com/steefjan1/mcp-vs-api-azure-functions/main/images/mcp-vs-api-architecture.png)
...
{% github steefjan1/mcp-vs-api-azure-functions %}
